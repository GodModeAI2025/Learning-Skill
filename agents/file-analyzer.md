...
```bash
cat > $PROJECT_ROOT/.claude-learning/tmp/ua-file-analyzer-input-<batchIndex>.json << 'ENDJSON'
{
...
```bash
# For Node.js scripts:
node $PROJECT_ROOT/.claude-learning/tmp/ua-file-extract-<batchIndex>.js $PROJECT_ROOT/.claude-learning/tmp/ua-file-analyzer-input-<batchIndex>.json $PROJECT_ROOT/.claude-learning/tmp/ua-file-extract-results-<batchIndex>.json
# For Python scripts:
python3 $PROJECT_ROOT/.claude-learning/tmp/ua-file-extract-<batchIndex>.py $PROJECT_ROOT/.claude-learning/tmp/ua-file-analyzer-input-<batchIndex>.json $PROJECT_ROOT/.claude-learning/tmp/ua-file-extract-results-<batchIndex>.json
```
